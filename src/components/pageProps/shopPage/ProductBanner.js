...
import { returnCategory } from "../../../constants";

const ProductBanner = ({ itemsPerPageFromBanner, onSelectedOptionChange }) => {
  ...
  useEffect(()=>{
    const fetchCat = async()=>{
      const data = await returnCategory();
      data ? setCategorys(data) : setCategorys([])
    }
    fetchCat()
  },[])
